            ...
            <div class="card">
                ...
                <div class="card-body" style="max-height:65vh; overflow-y:auto;">
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" name="title" placeholder="input Title" class="form-control  {{$errors->has('title') ? 'form-control is-invalid' : 'form-control'}}">
                        </div>
                        @if ($errors->has('title'))
                    ...
                    <div class="form-group">
                            ...
                            <div>
                                <input type="text" name="description" placeholder="Input Deskripsi" class="form-control  {{$errors->has('description') ? 'form-control is-invalid' : 'form-control'}}">
                            </div>
