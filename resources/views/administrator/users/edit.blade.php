        ...
        <form action="{{route('user.update', $user->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <div>
                            <label for="passwordConfrim" class="control-label"><small>Hak Akses</small></label>
                        </div>
                        <div>
                            <select name="hakases" class="form-control" required>
                                <option value="">--Pilih Hak Akses--</option>
                                @foreach ($roles as $role)      
                            <option value="{{$role->id}}" {{$role->id == $izin ? 'selected' : ''}}>{{$role->name}}</option>
                                @endforeach
                            </select>
                        </div>
